...
def get_opt():
    ...
    # Use absolute path for data root
    parser.add_argument("--dataroot", default=r"C:\Users\kaksh\Downloads\CP-VTON+\data")
    
    parser.add_argument("--datamode", default="test")
    parser.add_argument("--stage", default="GMM")

    # Use absolute path for data list
    parser.add_argument("--data_list", default=r"C:\Users\kaksh\Downloads\CP-VTON+\data\test_pairs.txt")
    ...
    parser.add_argument('--result_dir', type=str, default=r"C:\Users\kaksh\Desktop\Cpvton\result", help='save result infos')
