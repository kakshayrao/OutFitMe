...
class CPDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.stage == 'GMM':
            ...
            c = Image.open(r'C:\Users\kaksh\Desktop\Cpvton\result\GMM\test\warp-cloth\{}'.format(im_name))
            cm = Image.open(r'C:\Users\kaksh\Desktop\Cpvton\result\GMM\test\warp-mask\{}'.format(im_name)).convert('L')
